...
const AdminEmployeeList = () => {
  ...
  useEffect(() => {
    document.title = "Ansattes Opplæring – Statnett";
    fetchEmployees();
  }, []);
  ...
  const filtered = employees
    ...
    .filter((e) => e.name.toLowerCase().includes(search.toLowerCase()) || (e.department && e.department.toLowerCase().includes(search.toLowerCase())));
        ...
        <div className="mx-auto max-w-2xl px-5 py-6 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="font-display text-xl font-extrabold tracking-tight text-foreground">Ansattes Opplæring</h1>
